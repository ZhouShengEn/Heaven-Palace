package com.heaven.palace.lingxiaopalace.interceptor;
...
public class DataPermissionInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        try {
            DataPermission dataPermission = DataPermissionContext.local.get();
            ...
            if (invocation.getTarget() instanceof StatementHandler) {
                String condition = createCondition(dataPermission, userId);
                if (null == condition){
                    return invocation.proceed();
                }
     ...
     * @return
     */
    private String createCondition(DataPermission dataPermission, String userId) {
        switch (dataPermission.level()){
            case USER:
            case ALL:
