...
import com.heaven.palace.moonpalace.core.cache.CacheKit;
...
import com.heaven.palace.moonpalace.modular.system.warpper.RoleWarpper;
...
public class RoleController extends BaseController {
    ...
    public Tip remove(@RequestParam Integer roleId) {
        ...
        if (roleId.equals(Const.ADMIN_ROLE_ID)) {
            throw new BusinessException(500, "不能删除超级管理员！");
        }
