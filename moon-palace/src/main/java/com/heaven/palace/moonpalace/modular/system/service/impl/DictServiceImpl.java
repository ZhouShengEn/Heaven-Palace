...
import com.heaven.palace.moonpalace.common.constant.factory.MutiStrFactory;
...
import com.heaven.palace.moonpalace.modular.system.dao.DictDao;
import com.heaven.palace.moonpalace.modular.system.service.IDictService;
...
public class DictServiceImpl implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new BusinessException(BusinessExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new BusinessException(BusinessExceptionEnum.DICT_MUST_BE_NUMBER);
            }
