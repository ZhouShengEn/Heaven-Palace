...
import com.heaven.palace.moonpalace.core.shiro.check.PermissionCheckManager;
...
public class PermissionAop {
    ...
    @Pointcut(value = "@annotation(com.heaven.palace.moonpalace.common.annotion.Permission)")
