package com.heaven.palace.moonpalace.component.shiro.config;

import com.heaven.palace.moonpalace.component.shiro.filter.ShiroAuthenticationFilter;
import com.heaven.palace.moonpalace.config.properties.GunsProperties;
import com.heaven.palace.moonpalace.core.shiro.ShiroDbRealm;
...
public class ShiroConfig implements EnvironmentAware {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
         ...
         * 默认的登陆访问url
         */
//        shiroFilter.setLoginUrl("/global/sessionError");
        ...
        hashMap.put("/v2/login", "anon");
        hashMap.put("/register", "anon");
        hashMap.put("/kaptcha", "anon");
        hashMap.put("/**", "authc");

        shiroFilter.setFilterChainDefinitionMap(hashMap);
        shiroFilter.getFilters().put("authc", new ShiroAuthenticationFilter());
        return shiroFilter;
    }
