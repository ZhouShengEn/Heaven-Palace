...
import com.heaven.palace.moonpalace.util.ApiMenuFilter;
import com.heaven.palace.moonpalace.util.KaptchaUtil;
import com.heaven.palace.moonpalace.util.PatternUtil;
...
public class LoginController extends BaseController {
    ...
    public String registerVali(String username, String password) {
        ...
        if (theUser != null) {
            throw new UnknownAccountException(BusinessExceptionEnum.USER_ALREADY_REG.getMessage());
        }
