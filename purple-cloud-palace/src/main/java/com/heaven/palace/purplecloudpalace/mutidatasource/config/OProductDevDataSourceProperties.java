 ...
 */
@Component
@ConfigurationProperties(prefix = "spring.datasource.business.product.dev")
public class OProductDevDataSourceProperties {

    //默认的数据源名称
    private String defaultDataSourceName = "dataSourceProductDev";
