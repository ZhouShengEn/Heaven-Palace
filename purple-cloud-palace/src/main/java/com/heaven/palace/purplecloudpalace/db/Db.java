package com.heaven.palace.purplecloudpalace.db;
...
/**
 * <p> 便捷数据库操作类 <p> <p> 本类的使用情景： <p> 1.单纯想创建现有的Mapper <p>例如: Db.getMapper(UserLoginMapper.class).selectById("14779707158513204");<br>
 * <p>
 *
 * @author ZhouShengEn
 * @date 2022年8月25日
...
public class Db<T> {
    ...
    /**
     * <p> 创建包含指定mapper的Db工具类,使用本类的第一种用法
     *
