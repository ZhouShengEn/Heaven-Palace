...
public class StrKit {
    ...
    /**
     * 字符串是否为非空白 空白的定义如下： <br> 1、不为null <br> 2、不为不可见字符（如空格）<br> 3、不为""<br>
     *
     * @param str 被检测的字符串
     * @return 是否为非空
     */
    ...
    /**
     * 字符串是否为空，空的定义如下 1、为null <br> 2、为""<br>
     *
     * @param str 被检测的字符串
     * @return 是否为空
     */
    ...
    /**
     * 字符串是否为非空白 空白的定义如下： <br> 1、不为null <br> 2、不为""<br>
     *
     * @param str 被检测的字符串
     * @return 是否为非空
     */
    ...
    /**
     * 获得set或get方法对应的标准属性名<br/> 例如：setName 返回 name
     *
    ...
    /**
     * 格式化文本, {} 表示占位符<br> 例如：format("aaa {} ccc", "bbb")   ---->    aaa bbb ccc
     *
